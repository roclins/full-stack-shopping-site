              ...
              <li v-for="(item,index) in cartList" :key="index">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        ...
                        <span class="select-ipt">{{Number(item.productNum)}}</span>
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" @click="delGoods(item)">
            ...
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;" @click="selectAll">
                  <span class="checkbox-btn item-check-btn" v-bind:class="{'check':isSelectAll}">
                    <svg class="icon icon-ok">
                      <use xlink:href="#icon-ok"></use>
                    </svg>
                  </span>
...
export default {
  ...
  computed: {
    isSelectAll() {
      return this.cartList.length === this.selectedCount;
    },
    selectedCount() {
      var i = 0;
    ...
    totalPrice(){
        ...
        this.cartList.forEach((item)=>{
            if(item.checked === '1'){
                total +=Number(item.salePrice)*Number(item.productNum)
            }
        });
        return total;
    }
  ...
  methods: {
    ...
    selectAll() {
      // this.isSelectAll = !this.isSelectAll; 这样赋值是不行的，因为computed是计算属性，
      let flag = !this.isSelectAll;
    //   console.log(flag);
    //   console.log(this.isSelectAll, this.selectedCount);
      this.cartList.forEach(item => {
