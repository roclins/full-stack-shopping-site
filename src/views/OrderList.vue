      ...
      <div class="checkout-order">
          ...
          <div class="price-count">
            <ul>
              <li>
                ...
                <span>{{goodsTotalPrice|currency('$')}}</span>
              </li>
              <li>
                <span>Shipping:</span>  
        ...
        <div class="order-foot-wrap">
          <div class="prev-btn-wrap">
            <router-link class="btn btn--m" :to="{path:'/address'}">Previous</router-link>
          </div>
  ...
  methods: {
    ...
    totalPrice(){
      this.cartList.forEach((item)=>{
        this.goodsTotalPrice +=Number(item.salePrice)*Number(item.productNum); 
      });
      this.orderTotalPrice = this.goodsTotalPrice + this.shipping + this.discount + this.tax;
    },
    payment(){
